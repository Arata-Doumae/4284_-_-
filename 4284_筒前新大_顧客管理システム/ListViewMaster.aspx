<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ListViewMaster.aspx.vb" Inherits="_4284_筒前新大_顧客管理システム.ListViewMaster" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    

           <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource1" DataKeyNames="CustomerID" GroupItemCount="3" InsertItemPosition="LastItem">
